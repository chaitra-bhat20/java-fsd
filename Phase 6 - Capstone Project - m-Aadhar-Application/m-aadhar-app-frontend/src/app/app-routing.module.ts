...
import { ApproveVerifyAadharComponent } from './approve-verify-aadhar/approve-verify-aadhar.component';
...
const routes: Routes = [
  ...
  // {path:"adminHome",component:AdminAadharViewComponent}
  {path:"findAllAadhar",component:AdminAadharViewComponent},
  {path:"approveVerifyAadhar",component:ApproveVerifyAadharComponent},
  {path:"duplicateaadhar",component:ApproveVerifyAadharComponent},
];
