...
public class citizensDao {
    ...
    public Optional<citizens> getCitizensByVaccinationCenterId(Long vaccinationCenterId){
    	return citizensRepository.findByVaccinationCenterId(vaccinationCenterId);
    }
